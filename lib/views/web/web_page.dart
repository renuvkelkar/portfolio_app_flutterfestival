...
import 'package:portfolio_app_flutterfestival/views/web/widgets/contact_web.dart';
import 'package:portfolio_app_flutterfestival/views/web/widgets/skills_web.dart';
import 'package:velocity_x/velocity_x.dart';

import 'widgets/intro_section.dart';
import 'widgets/project_web.dart';
              ...
              Row(
                ...
                children: [
                  ...
                  HoverAnimatedContainer(
                    ...
                    hoverColor: Colors.deepPurpleAccent.shade100,
                    child: MaterialButton(
                        child: new Text("Skills").text.xl.white.make(),
                        onPressed: () {
                          setState(() {
